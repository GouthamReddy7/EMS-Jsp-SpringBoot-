...
@WebServlet("/ViewApprovedComplaintsAdminServlet")
public class ViewApprovedComplaintsAdminServlet extends HttpServlet{
	public void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		...
		if(isAuthenticated!=null && isAuthenticated) {
			...
			String jsonResponse = ComplaintAPIservice.getApprovedComplaintlist(jsonPayload);
			...
			if (!jsonResponse.isEmpty()) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("customerComplaintStatus.jsp");
