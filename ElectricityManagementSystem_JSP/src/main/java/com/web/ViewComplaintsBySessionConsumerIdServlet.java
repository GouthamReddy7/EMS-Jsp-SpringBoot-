...
@WebServlet("/ViewComplaintsBySessionConsumerIdServlet")
public class ViewComplaintsBySessionConsumerIdServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (isAuthenticated != null && isAuthenticated) {
			...
			if (!jsonResponse.isEmpty()) {
				...
				System.out.println(">>INSIDE ViewAllComplaintByConsumerIdServlet: jsonResponse" + jsonResponse);
