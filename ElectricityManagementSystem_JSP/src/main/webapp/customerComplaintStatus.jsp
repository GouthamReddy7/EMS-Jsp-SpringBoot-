...
<body>
    ...
    <form action="UpdateFeedbackCustomerServlet" method="get">
				...
				<tbody>
					...
					<c:forEach var="complaint" items="${complaintList}">
						<tr>
							...
							<td><textarea id="complaintFeedback" name="complaintFeedback" placeholder="Feedback"></textarea></td>
							<td><button type="button" ><a href="UpdateFeedbackCustomerServlet?complaintId=${complaint.complaintId}&complaintFeedback=hi">Submit</a></button></td>
						</tr>
					</c:forEach>
				</tbody>
