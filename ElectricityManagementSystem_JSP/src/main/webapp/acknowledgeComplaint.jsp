...
<body>
	...
	<div class="container">
		...
		<div class="info-box">
			...
			<h6>
				Complaint Type:
				<%=request.getAttribute("complaintType")%>
			</h6>

			<h6>
				Complaint ID:
				<%=request.getAttribute("complaintId")%>
			</h6>

			<h6>
				Customer Name:
				<%=request.getAttribute("contactPerson")%>
			</h6>


		</div>

		<button class="btn-home" onclick="location.href='home.jsp'">Go
			Back</button>
